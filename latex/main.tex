...
% -------------------- Thong tin de trong --------------------
\newcommand{\TenTruong}{ĐẠI HỌC BÁCH KHOA HÀ NỘI}
\newcommand{\TenKhoa}{TRƯỜNG CÔNG NGHỆ THÔNG TIN VÀ TRUYỀN THÔNG}
\newcommand{\TenMonHoc}{Hệ điều hành}
\newcommand{\TenGiangVien}{Phạm Đăng Hải}
\newcommand{\TenNhom}{%
Nguyễn Hoàng Anh - 202416118\par
Nguyễn Quang Anh - 202416111\par
Nguyễn Chính Minh - 202416293%
}
\newcommand{\TenLop}{168463}
\newcommand{\HocKy}{20252}
\newcommand{\ThangNamBaoCao}{\makebox[2.8cm]{23/06/2026}}
...
\begin{titlepage}
	\begin{center}
		\vspace*{0.8cm}
		{\Large \textbf{\MakeUppercase{\TenTruong}}}\\[0.18cm]
		{\Large \textbf{\MakeUppercase{\TenKhoa}}}\\[-0.02cm]
		{\textbf{-----\&\&-----}}\\[0.35cm]

		\includegraphics[height=5.4cm]{figures/logo.png}\\[1.1cm]

		{\LARGE \textbf{BÁO CÁO}}\\[0.3cm]
		{\LARGE \textbf{PROJECT: TINY SHELL}}\\[0.3cm]
		{\Large \textbf{THIẾT KẾ VÀ CÀI ĐẶT SHELL ĐƠN GIẢN TRÊN WINDOWS}}\\[1.1cm]
	\end{center}

	\begin{center}
		\renewcommand{\arraystretch}{1.15}
		\large
		\begin{tabular}{>{\bfseries}p{4.1cm}@{\hspace{0.25cm}:\hspace{0.25cm}}p{7.2cm}}
			GVHD           & \textbf{\TenGiangVien} \\
			Nhóm thực hiện & \textbf{\TenNhom}      \\
			Môn học        & \textbf{\TenMonHoc}    \\
			Mã lớp            & \textbf{\TenLop}       \\
			Học kỳ         & \textbf{\HocKy}        \\
		\end{tabular}
	\end{center}
	...
	\vfill
	\begin{center}
		{\large \textbf{Hà Nội, \ThangNamBaoCao}}
	\end{center}
\end{titlepage}
...
Trong học phần Hệ điều hành, việc tìm hiểu cơ chế hoạt động của shell giúp sinh viên nắm rõ hơn cách hệ điều hành tiếp nhận lệnh, tạo tiến trình, quản lý tiến trình và xử lý các tình huống tương tác với người dùng. Đề tài \textbf{Tiny shell} được thực hiện nhằm xây dựng một shell đơn giản trên Windows, qua đó vận dụng các kiến thức về tiến trình, lệnh nội trú, lệnh ngoài và Win32 API vào một chương trình hoàn chỉnh.

Báo cáo này trình bày quá trình phân tích yêu cầu, thiết kế kiến trúc, cài đặt các chức năng chính, kiểm thử chương trình và đánh giá kết quả đạt được. Trong quá trình thực hiện, nhóm đã cố gắng tổ chức mã nguồn rõ ràng, kiểm tra từng chức năng theo yêu cầu và ghi nhận các hạn chế còn tồn tại để có cơ sở cải tiến trong tương lai.

Nhóm xin chân thành cảm ơn giảng viên hướng dẫn \textbf{\TenGiangVien} đã định hướng quá trình thực hiện đề tài.
...
\begin{longtable}{|>{\centering\arraybackslash}p{0.9cm}|p{4.0cm}|p{8.6cm}|}
	\hline
	\textbf{STT} & \textbf{Họ và tên}     & \textbf{Công việc chính}                                  \\
	\hline
	1            & Nguyễn Chính Minh  & Phân tích yêu cầu, thiết kế kiến trúc shell, viết báo cáo \\
	\hline
	2            & Nguyễn Hoàng Anh   & Cài đặt parser, foreground/background process, kiểm thử   \\
	\hline
	3            & Nguyễn Quang Anh   & Cài đặt built-in commands, quản lý tiến trình, PATH       \\
	\hline
\end{longtable}
...
Shell là chương trình trung gian cho phép người dùng nhập lệnh, phân tích lệnh và yêu cầu hệ điều hành thực hiện công việc tương ứng. Thông qua việc xây dựng shell, nhóm có thể thực hành các khái niệm quan trọng của môn Hệ điều hành như tạo tiến trình, đồng bộ foreground/background, xử lý tín hiệu bàn phím và quản lý biến môi trường.

Đề tài \textbf{Tiny shell} yêu cầu thiết kế một shell đơn giản trên Windows, đặt tên là \textbf{myShell}. Chương trình được viết bằng C99 và sử dụng Win32 API để thực thi lệnh ngoài, quản lý tiến trình nền, cài đặt các lệnh nội trú và xử lý lỗi khi người dùng nhập lệnh không hợp lệ.

Các yêu cầu chính của đề tài gồm:
\begin{itemize}[leftmargin=1.2cm]
	\item Nhận lệnh, tách tham số và phân biệt lệnh nội trú với lệnh ngoài.
	\item Hỗ trợ foreground/background process và quản lý tiến trình nền.
	\item Cài đặt các lệnh cơ bản như \texttt{cd}, \texttt{dir}, \texttt{list}, \texttt{kill}, \texttt{stop}, \texttt{resume}.
	\item Xử lý \texttt{CTRL+C}, hỗ trợ file \texttt{.bat}/\texttt{.cmd} và xây dựng bộ kiểm thử.
\end{itemize}

\section{Phạm vi báo cáo}

Báo cáo không trình bày toàn bộ mã nguồn dòng theo dòng, mà tập trung vào kiến trúc module, cấu trúc dữ liệu, luồng xử lý lệnh, cách sử dụng Win32 API, kết quả kiểm thử và các hạn chế còn tồn tại.
...
Lệnh \texttt{cd} là ví dụ điển hình bắt buộc phải là lệnh nội trú. Nếu chạy \texttt{cd} bằng một tiến trình con, thư mục làm việc chỉ thay đổi trong tiến trình con và không ảnh hưởng tới shell cha. Vì vậy chương trình phải gọi \texttt{SetCurrentDirectoryW} ngay trong tiến trình shell.
...
\begin{longtable}{|p{4.2cm}|p{10.3cm}|}
	...
	\hline
	\texttt{CreateProcessW}                       & Tạo tiến trình con để chạy lệnh ngoài hoặc file batch.                         \\
	\hline
	...
	\hline
	\texttt{TerminateProcess}                     & Dừng chắc chắn foreground process khi người dùng nhấn \texttt{CTRL+C}.          \\
	\hline
	...
	\hline
	\texttt{SetCurrentDirectoryW}                 & Thay đổi thư mục làm việc của shell.                                           \\
	\hline
	\texttt{SetEnvironmentVariableW}              & Cập nhật biến môi trường \texttt{PATH} trong phiên shell hiện tại.             \\
	\hline
\end{longtable}
...
\begin{longtable}{|p{1.2cm}|p{5cm}|p{8cm}|}
	...
	\hline
	7            & Xử lý \texttt{CTRL+C}  & Khi foreground process đang chạy, shell gửi yêu cầu ngắt tới nhóm tiến trình con và vẫn tiếp tục sống. \\
	\hline
...
\begin{itemize}[leftmargin=1.2cm]
	...
	\item Có bộ kiểm thử hồi quy \texttt{tests\textbackslash regression.ps1} để kiểm tra các chức năng chính.
	\item Hỗ trợ gợi ý lệnh, hoàn thiện bằng phím Tab và tìm lịch sử theo tiền tố bằng phím mũi tên.
...
\begin{longtable}{|p{4cm}|p{10.5cm}|}
	...
	\hline
	\texttt{process.c}       & Xây dựng command line Windows, gọi \texttt{CreateProcessW}, xử lý foreground/background và file batch.                 \\
	\hline
	...
	\hline
	\texttt{line\_editor.c}  & Đọc phím tương tác, hiển thị gợi ý, hoàn thiện bằng Tab và tìm lịch sử theo tiền tố.                                   \\
	\hline
	\texttt{shell\_utils.c}  & Cung cấp hàm báo lỗi thống nhất dựa trên \texttt{FormatMessageW}.                                                      \\
	\hline
\end{longtable}
...
Khoi dong shell
    ...
    -> Lap vo han:
        ...
        6. Neu la lenh ngoai: tao child process bang CreateProcessW
...
Trên Windows, \texttt{CreateProcessW} nhận một chuỗi command line thay vì mảng \texttt{argv} như một số hệ thống Unix. Vì vậy chương trình phải ghép lại các tham số thành một command line hợp lệ. Hàm \texttt{append\_arg()} xử lý trường hợp tham số có khoảng trắng, dấu nháy hoặc dấu gạch chéo ngược.
...
Hàm \texttt{run\_process()} là phần trung tâm khi chạy lệnh ngoài. Sau khi xây dựng command line, chương trình gọi \texttt{CreateProcessW}. Tất cả tiến trình con được tạo với cờ \texttt{CREATE\_NEW\_PROCESS\_GROUP} để phục vụ xử lý \texttt{CTRL+C} theo nhóm tiến trình.

\begin{lstlisting}[language=C,caption={Gọi CreateProcessW để tạo tiến trình con}]
ok = CreateProcessW(
    NULL,
    final_cmdline,
    NULL,
...
File \texttt{test.bat} chỉ dùng để minh họa khả năng chạy batch. Bộ kiểm thử hồi quy được chạy bằng \texttt{powershell -File tests\textbackslash regression.ps1}.

\section{Xử lý \texttt{CTRL+C}}

Trong shell thông thường, \texttt{CTRL+C} dùng để hủy chương trình đang chạy foreground. Nếu xử lý không đúng, chính shell cũng bị tắt. Project đăng ký console control handler bằng \texttt{SetConsoleCtrlHandler}. Khi có foreground process, shell gọi \texttt{TerminateProcess} với mã thoát 130. Cách này dừng chắc chắn cả những chương trình như Windows \texttt{ping}, vốn chỉ in thống kê rồi tiếp tục khi nhận \texttt{CTRL\_BREAK\_EVENT}. Đổi lại, tiến trình con không có cơ hội dọn dẹp mềm.
...
static BOOL WINAPI ctrl_handler(DWORD ctrl_type)
{
    if (ctrl_type == CTRL_C_EVENT || ctrl_type == CTRL_BREAK_EVENT) {
        if (g_fg_pid != 0) {
            TerminateProcess(g_fg_process, 130);
            return TRUE;
        }
        printf("\n");
        return TRUE;
...
\begin{longtable}{|p{3.2cm}|p{11cm}|}
	...
	\hline
	\texttt{cd [path]}                                           & Không có tham số thì in thư mục hiện tại; có tham số thì gọi \texttt{SetCurrentDirectoryW}.                      \\
	\hline
	\texttt{dir [path]}                                          & Liệt kê trực tiếp bằng \texttt{FindFirstFileW}/\texttt{FindNextFileW}, không chuyển tham số qua \texttt{cmd.exe}. \\
	\hline
	\texttt{path}                                                & Đọc biến môi trường \texttt{PATH} bằng \texttt{getenv}, tách theo dấu chấm phẩy và in từng dòng.                 \\
	\hline
	\texttt{addpath <dir>}                                       & Ghép thư mục mới vào cuối \texttt{PATH} và gọi \texttt{SetEnvironmentVariableW}.                                 \\
	\hline
...
Thay vì in mã lỗi thô từ \texttt{GetLastError}, project xây dựng hàm \texttt{shell\_perror()} dùng \texttt{FormatMessageW} để chuyển mã lỗi Windows thành chuỗi dễ hiểu.

\begin{lstlisting}[language=C,caption={Hàm báo lỗi dùng FormatMessageW}]
...
Bộ kiểm thử \texttt{tests\textbackslash regression.ps1} kiểm tra tự động các chức năng cơ bản. Một số chức năng tương tác như \texttt{notepad \&}, \texttt{stop}, \texttt{resume}, \texttt{kill} và \texttt{CTRL+C} vẫn được kiểm thử thủ công.
...
\subsection{Kiểm thử bằng \texttt{tests\textbackslash regression.ps1}}

Script hồi quy kiểm tra lặp \texttt{addpath}, đường dẫn Unicode, lệnh \texttt{dir} native, tham số batch an toàn và khả năng phục hồi sau dòng lệnh quá dài. Các chức năng background process và \texttt{CTRL+C} vẫn được kiểm thử thủ công.
...
\begin{table}[H]
	...
	\begin{tabularx}{\textwidth}{|p{1.2cm}|X|p{3cm}|}
		...
		\hline
		6            & \texttt{CTRL+C} dừng foreground process, shell tiếp tục sống & Hoàn thành          \\
		\hline
		7            & Hỗ trợ file \texttt{.bat}/\texttt{.cmd}                     & Hoàn thành          \\
		\hline
		8            & Báo lỗi Win32 rõ ràng bằng \texttt{FormatMessageW}          & Hoàn thành          \\
		\hline
	\end{tabularx}
...
\begin{itemize}[leftmargin=1.2cm]
	...
	\item Mở rộng completion để tự động hoàn thiện tên file và mọi chương trình có trong \texttt{PATH}.
	...
	\item Với phần mềm thực tế, ưu tiên cơ chế phối hợp với tiến trình đích hoặc debugger API thay vì cưỡng bức suspend từng thread.
\end{itemize}
...
\begin{thebibliography}{9}
	...
	Microsoft Learn, \textit{CreateProcessW function - processthreadsapi.h}.
